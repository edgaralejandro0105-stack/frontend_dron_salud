...
import { getProfile, updateUsuario, changePassword, uploadFile } from '../../api'
  ...
  async function handleSaveProfile(e) {
    ...
    try {
      ...
      await updateUsuario(userId, {
        ...
        cedula: form.cedula, email: form.email, telefono: form.telefono,
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Administra tu cuenta</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div className="flex items-center gap-5 pb-4 border-b border-gray-100">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-gray-400 mt-0.5">Toca la cámara para cambiar tu foto</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input value={form.nombre} onChange={e => setForm({ ...form, nombre: e.target.value })} placeholder="Nombre" className={inputClass + ' pl-9'} required />
                  </div>
                </div>
                <div>
                  <label className={labelClass}>Apellido</label>
                  <input value={form.apellido} onChange={e => setForm({ ...form, apellido: e.target.value })} placeholder="Apellido" className={inputClass} />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input value={form.cedula} onChange={e => setForm({ ...form, cedula: e.target.value })} placeholder="V-12345678" className={inputClass + ' pl-9'} />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} placeholder="correo@email.com" className={inputClass + ' pl-9'} required />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input value={form.telefono} onChange={e => setForm({ ...form, telefono: e.target.value })} placeholder="0412-1234567" className={inputClass + ' pl-9'} />
                  </div>
                </div>
              </div>
              <div className="pt-3">
